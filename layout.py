...
Uploaded data is stored in a [dash core component Store](https://dash.plotly.com/dash-core-components/store) using local storage. 
The json data is stored in browser storage and is never saved on the server.
